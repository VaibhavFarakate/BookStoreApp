            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row'>
                <div className='w-full md:w-1/2 mt-12 md:mt-32 order-2 md:order-1'>
                    <div className="space-y-12">
                        ...
                        <p className='text-xl'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aliquam, iure dolor soluta tempora asperiores aut omnis sint assumenda, iste dolorum itaque, vero rem saepe magnam ut minus quae ea ratione.</p>
                ...
                <div className='w-full md:w-1/2 mt-12 md:mt-32 order-1 md:order-2'>
                    <img src={Banner_Img} alt="main-Img" className='w-80 h-80 mx-auto' />
                </div>
            </div>
        </>
    )
